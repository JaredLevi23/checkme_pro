...
class EcgRecordDetailsPage extends StatefulWidget {
  const EcgRecordDetailsPage({Key? key}) : super(key: key);

  @override
  State<EcgRecordDetailsPage> createState() => _EcgRecordDetailsState();
}

class _EcgRecordDetailsState extends State<EcgRecordDetailsPage> {
  ...
  Widget build(BuildContext context) { 
    ...
    EcgDetailsModel? ecgDetails = checkmeProvider.ecgDetailsList[ currentModel.dtcDate ];
